...
<html lang="en">
  ...
  <body class="fixed-nav sticky-footer bg-dark" id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
      <a class="navbar-brand" href="index.php"><i class="fa fa-fw fa-envelope" style="padding-right: 15px"></i>E-mail</a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
          <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Malicious">
            <a class="nav-link" href="malicious.php" style="background-color: #212529;">
      ...
      <div class="content-wrapper">
        <?php
          ...
          foreach ($scanned_directory as $file) {
              ...
              echo "<tr>";
              echo "<td><span class='badge badge-pill badge-danger' style='width:80px'>Malicious</span></td>";
